...
public class PrintAllMusicsGenreAction implements Action {
    private MusicService musicService;

    public PrintAllMusicsGenreAction() {
    ...
    public void execute() throws SQLException {
        ...
        musicService.printMusicsByGenre(request.ask().get(0).getValue().toString());
    }
}
